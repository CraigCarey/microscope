...
Router.configure({
    ...
    // subscribe to the publication functions defined in server/publications.js
    // this means that for every route on the site, we want to subscribe to the posts & comments publications
