...
PostsListsController = RouteController.extend({
    template: 'postsList',  // assign the template
    increment: 5,           // add an increment property

    // returns the current limit, by parsing the url
    postsLimit: function() {
    ...
    // waitOn and data are similar to how we used them in 'Router.route('/:postsLimit?..'
